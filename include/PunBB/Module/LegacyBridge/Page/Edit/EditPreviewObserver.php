...
/**
 * Renders ed_preview_pre_display with the preview's heading in
 * $forum_page['post_ident'] and its message in ['preview_message'], both read back.
 */
final class EditPreviewObserver {
	public function __construct(private readonly PageScope $scope) {}

	public function observe(EditPreviewAssembling $event): void {
		if (!LegacyScope::attached('ed_preview_pre_display'))
			return;
		...
		$event->append($this->scope->renderObserved('ed_preview_pre_display', $event));
