...
namespace PunBB\Module\Login\View;
...
/**
 * The login form or the form asking for a new password as the template shows
...
final class FormView {
	...
	public function place(LoginRendering|PasswordRequestRendering $event): void {
