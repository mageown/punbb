...
namespace PunBB\Module\Register\View;
...
/**
 * The forum rules or the registration form as the template shows them, built
 * in the order the page is read: the markup placed at each position, and the
 * numbers the form gives its field group, items and fields.
 */
final class FormView {
	...
	public function place(RulesRendering|RegistrationRendering $event): void {
	...
	/** The rules number their fields from none again once they start, whatever the start left. */
	public function restartFields(): void {
		$this->fieldCount = 0;
	}
