...
class DBLayer
{
	...
	public function __construct($db_host, $db_username, $db_password, $db_name, $db_prefix, $foo)
	{
		...
		catch (mysqli_sql_exception $e)
		{
			...
			error('Unable to connect to MySQL and select database.'.(defined('FORUM_DEBUG') ? '<br />MySQL reported: '.forum_htmlencode($e->getMessage()) : ''), __FILE__, __LINE__);
		}
	...
	public function close()
	{
		if ($this->link_id)
		{
			...
			// close() is called explicitly (forum_end_page()) and again on shutdown.
			try
			{
