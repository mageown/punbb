...
'Mysql type info'			=>	'The two MySQL options differ only in storage engine: "<em>MySQL Improved</em>" uses MyISAM and "<em>MySQL Improved (InnoDB)</em>" uses InnoDB. Choose InnoDB unless you have a reason not to.',
